...
import ProductListing from '../screens/ProductListingScreen';
...
export default function MainNavigator({ navigation, }) {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name='HomeScreen' component={DrawerScreen} options={{ headerShown: false, }} />
      <Stack.Screen name="Product" component={ProductDetailScreen} options={{ headerShown: false }} />
      <Stack.Screen name="billingaddressDetails" component={BillingAdressDetails} options={{ headerShown: false }} />
      <Stack.Screen name='shippingaddressDetails' component={ShippingAddressDetails} options={{ headerShown: false }} />
      ...
      <Stack.Screen name='my_order' component={OrderScreen} options={{ headerShown: false }} />
      <Stack.Screen name='my_wishlist' component={WishListScreen} options={{ headerShown: false }} />
      <Stack.Screen name='my_profile' component={MyProfileScreen} options={{ headerShown: false }} />
      <Stack.Screen name='Addresses' component={AddressesScreen} options={{ headerShown: false }} />
      <Stack.Screen name='reviews' component={ReviewsScreen} options={{ headerShown: true, headerTitle: 'Allreviews' }} />
      <Stack.Screen name='offer_coupan' component={CoupanOfferScreen} options={{ headerShown: false }} />
      <Stack.Screen name='AllBestseller' component={ViewAllBestsellers} options={{ headerShown: true }} />
      ...
      <Stack.Screen name='ProductListing' component={ProductListing}
        ...
        options={({ navigation, route }) => ({
          ...
          // headerTitle: () => console.log('route', route),
          headerRight: () => (
